                    ...
                    foreach ((array)$cartItem['quantity'] as $quantity) {
                        ...
                        if ($product->product_id == $id) {
                            ...
                            echo '
                                ...
                                <div class="text-center">' . (int)$quantity . '</div>
                                <div class="text-right font-medium">Ksh ' . number_format((int)$product->product_price, 2, '.', ',') . '</div>
                                </div> ';
                            $productTotal = (int)$product->product_price * (int)$quantity;
                        }
                    }
                }
            }
                                        ...
                                        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <div style="color: #000000; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;">' . (int)$quantity . '</span></p>
                                                </div> 
                                                </td>
                                            </tr>
                                            </tbody>
                                        ...
                                        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <div style="color: #000000; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;">Ksh :' . number_format((int)$product->product_price, 2, '.', ',') . '</span></p>
                                                </div> 
                                                </td>
                                            </tr>
                                            </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%; text-align: right;"><span style="font-size: 18px; line-height: 25.2px;"><strong><span style="font-family: Cabin, sans-serif; line-height: 25.2px; font-size: 18px;">Ksh:' . ' ' . number_format($productTotal, 2, '.', ',') . '</span></strong></span></p>
                              </div>
