...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #dce9e9">
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-family: Cabin, sans-serif; font-size: 20px; line-height: 28px;"><strong> <?= $_SESSION['name'] ?> Invoice #: 00<?= $_SESSION['id'] ?>-<?= date('Y') ?></strong></span><br /><span style="font-family: Cabin, sans-serif; font-size: 20px; line-height: 28px;"><?= date('l, d F Y ') ?></span></p>
                                </div>
                          ...
                          <tbody>
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                ...
                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Cabin, sans-serif;"><strong><?= $_SESSION['name'] . ' ' . $user['last_name'] ?></strong></span><br /><span style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;"><?= $user['address'] ?></span><br /><span style="color: #3598db; font-size: 14px; line-height: 19.6px; font-family: Cabin, sans-serif;"><?= $user['email'] ?></span><br /><span style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;">+254 <?= $user['phoneno'] ?></span></p>
                                </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="color: #000000; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span>To be paid before</span><b> <?= date('l, d F Y', strtotime("+10 days")); ?> </b>through <b style="text-decoration: underline;">M-pesa</b> specifying the invoice number</p>
                              </div>
  ...
  <script>
var email = document.documentElement;
