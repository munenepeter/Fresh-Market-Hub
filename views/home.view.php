...
<main>  
  <div class="w-full">
    <div
      class="h-auto rounded bg-transparent  flex flex-col items-center pt-12 sm:pt-24 pb-16 sm:pb-28 md:pb-48 lg:pb-32xl:pb-48 bg-no-repeat bg-cover bg-blend-color-burn"
      style="background-image: url('https://images.unsplash.com/photo-1542838132-92c53300491e?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Z3JvY2VyeXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80');">
      ...
      ?>
        ...
        <article class="flex flex-col bg-gray-50">
          ...
          <div class="flex flex-col flex-1 p-6">
            ...
            <a href="#"
              class=" text-center text-xs tracking-wider uppercase hover:underline text-blue-600"><?= $product->product_name; ?></a>
