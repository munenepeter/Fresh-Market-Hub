                                    ...
                                    <div class="px-4 py-4 bg-white space-y-6 sm:p-6">
                                        ...
                                        <div class="grid grid-cols-3 gap-6">
                                            <div class="col-span-3 sm:col-span-2">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <input type="text" name="product-name" id="product-name" class="mt-1  py-2 px-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-md sm:text-sm border-gray-300 rounded-md" placeholder="What is your product name?">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <!-- <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                ...
                                                <input type="text" name="postal_code" id="postal_code" autocomplete="postal-code" class="mt-1 py-2 px-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-md sm:text-sm border-gray-300 rounded-md">
                                            </div> -->
                                        </div>
                                        <div>
