...
<div class="md:max-w-6xl md:mx-auto px-4 py-8">
	...
	<div class="overflow-x-auto bg-white rounded-lg shadow mb-8 overflow-auto" style="height: 35vh;">
		<table class="relative min-w-full divide-y divide-gray-200">
			<thead class="bg-blue-50" style="position: sticky; top: 0;">
				<tr class="text-left">
					...
					<th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs">Amount
					</th>
